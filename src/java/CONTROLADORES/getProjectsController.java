...
public class getProjectsController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            ArrayProjects = new Operaciones().getProjects(Con);
            System.out.println("1");
            if(ArrayProjects.isEmpty()){
   myException ex = new myException(112,"No existen proyectos que mostrar","getAllProjects","../getImagesController3");
                ...
                HttpSession session = request.getSession(true);
                session.setAttribute("objArrayProjects", ArrayProjects);
                System.out.println("se creó obj proyecto");
                response.sendRedirect("VISTAS/menuAdmin.jsp");
            }
