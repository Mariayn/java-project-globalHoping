    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if(ArrayImages.isEmpty()){
              myException ex = new myException(110,"No existen imagenes que mostrar","getAllProjects","../getImagesController3");
                ...
                response.sendRedirect("VISTAS/createFundraiser.jsp");
                System.out.println("4");
            }
            
            //redirigir a createFundraiser.jsp
